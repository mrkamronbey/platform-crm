...
function TeacherEdit({ menuCollapse }) {
  // ! accordion  function
            ...
            >
              ...
              <div className="c-form-education">
                ...
                <ul className="c-form-list c-form-lists c__form-list">
                  ...
                  <li className="c-form-item">
                    <label className="c-form-label c-blue-color">Studying language</label>
                    <select required className="c-forms-input c-form-select">
                ...
                <div>
                  <Accordion>
                    ...
                    <AccordionDetails>
                      <ul className="c-form-list c-form-lists c__form-list">
                        <li className="c-form-item">
                          <label className="c-form-label c-blue-color">Experience</label>
                          <div className="c-form-item-check">
                            <input
                              required
                              placeholder="2years "
                        ...
                        <li className="c-form-item">
                          <label className="c-form-label c-blue-color">Graduation</label>
                          <div className="c-form-item-check">
                            <input
                              required
                        ...
                        <li className="c-form-item">
                          <label className="c-form-label c-blue-color">Language</label>
                          <select
                            required
                        ...
                        <li className="c-form-item">
                          <label className="c-form-label c-blue-color">Level language</label>
                          <select
                            required
                            className="c-forms-input c-form-select"
                          >
