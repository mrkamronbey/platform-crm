...
function WorkerForm({ menuCollapse }) {
                ...
                >
                  <ul className="c-form-list">
                    ...
                    <li className="c-form-item">
                      ...
                      <input
                        required
                        placeholder="Enter worker’s middle name"
                        className="c-forms-input"
                        type="text"
                      />
                    </li>
                    ...
                    <li className="c-form-item">
                      ...
                      <input
                        required
                        placeholder="Choose worker’s location"
                        className="c-forms-input"
                        type="text"
                      />
                    </li>
          ...
          <TabPanel value="2" className="c-scroll-panel">
            ...
            >
              <div className="c-formBIg">
                ...
                >
                  <ul className="c-form-lists1">
                    <li className="c-form-item">
                      <label className="c-form-label">Direction of work</label>
                      <input
                        required
                        placeholder="Work"
                        className="c-forms-input"
