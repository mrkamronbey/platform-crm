      ...
      <Box sx={{ width: "100%", typography: "body1" }}>
        <TabContext value={value}>
          ...
          <TabPanel value="2" className="c-scroll-panel">
              ...
              <div className="c-formBIg">
                ...
                >
                  <ul className="c-form-list c-form-lists">
                    ...
                    <li className="c-form-item">
                      <label className="c-form-label">Studying language</label>
                      <select required className="c-forms-input c-form-select">
                        <option style={{ color: "#999" }} disabled selected>
                          Choose Studying language
                        </option>
                        <option className="c-option" value="1">
                          Beginner
                        </option>
                    ...
                    <li className="c-form-item">
                      <label className="c-form-label">Teacher</label>
                      <select required className="c-forms-input c-form-select">
                        <option style={{ color: "#999" }} disabled selected>
                    ...
                    <li className="c-form-item">
                      <label className="c-form-label">Time of study</label>
                      <select required className="c-forms-input c-form-select">
                        <option style={{ color: "#999" }} disabled selected>
                          Time of study
                        </option>
                    ...
                    <li className="c-form-item">
                      <label className="c-form-label">Group</label>
                      <select required className="c-forms-input c-form-select">
                        <option style={{ color: "#999" }} disabled selected>
                          Group
                        </option>
            ...
            >
              <p className="c-sale-text">
                <span>Name of course:</span>
                <span className="c-sale-bold">Frontend Development</span>
              </p>
              <p className="c-sale-text">
                <span>Amount of payment:</span>
                <span className="c-sale-bold">5 000 000 sum</span>
              </p>
              <p className="c-sale-text">
                <span>Sale:</span>
                <span className="c-sale-bold" style={{ color: "#05FFD2" }}>
                  -21%
                </span>
              </p>
            </div>
